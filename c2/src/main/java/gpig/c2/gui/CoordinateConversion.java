...
/**
 * Converts geo coordinates - library code - modified
 * LatLong to UTM
 */
public class CoordinateConversion
{
  ...
  public int[] latLon2UTM(double latitude, double longitude)
  {
  ...
  {
    public int[] convertLatLonToUTM(double latitude, double longitude)
    {
