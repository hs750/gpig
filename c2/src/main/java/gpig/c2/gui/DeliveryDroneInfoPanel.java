 ...
 */
public class DeliveryDroneInfoPanel extends InfoPanel{
	
	private Location location;
	private DroneState state;
	
	public DeliveryDroneInfoPanel(UUID id, Location location, DroneState state, ActorType actorType, URL imageURL, Dimension size) {
